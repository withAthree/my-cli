...
describe('Validate TS configs', () => {
  it('Validate threea-eslint-config/typescript', async () => {
  ...
  it('Validate threea-eslint-config/typescript/vue', async () => {
  ...
  it('Validate threea-eslint-config/essential/typescript', async () => {
  ...
  it('Validate threea-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate threea-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate threea-eslint-config/typescript/node', async () => {
