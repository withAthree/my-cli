...
describe('Validate JS configs', () => {
  it('Validate threea-eslint-config', async () => {
  ...
  it('Validate threea-eslint-config/es5', async () => {
  ...
  it('Validate threea-eslint-config/vue', async () => {
  ...
  it('Validate threea-eslint-config/essential', async () => {
  ...
  it('Validate threea-eslint-config/essential/es5', async () => {
  ...
  it('Validate threea-eslint-config/essential/react', async () => {
  ...
  it('Validate threea-eslint-config/essential/vue', async () => {
  ...
  it('Validate threea-eslint-config/node', async () => {
